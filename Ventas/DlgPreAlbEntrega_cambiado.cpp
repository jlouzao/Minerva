...
BOOL CDlgPreAlbEntrega::OnInitDialog()
{
	...
	m_lstArticulos.InsertColumn(0,"Código", LVCFMT_LEFT, 70);			
	m_lstArticulos.InsertColumn(1,"Descripción", LVCFMT_LEFT, 174);
	m_lstArticulos.InsertColumn(2,"Peso", LVCFMT_LEFT, 60);
	m_lstArticulos.InsertColumn(3,"Pedido", LVCFMT_LEFT, 60);
	m_lstArticulos.InsertColumn(4,"Enviado", LVCFMT_LEFT, 60);
...
void CDlgPreAlbEntrega::BuscaArticulosPedido()
{
	...
	// Se rellena el listCtrl con los artículos que hayan sido alquilados
	int iIndice = 0;
...
void CDlgPreAlbEntrega::BuscaAlbaranes()
{
	...
	rsAlbaran.m_strFilter = "NUMPEDIDO LIKE '" + m_strPedido + "'";
...
void CDlgPreAlbEntrega::RellenaAlbaran()
{
	...
	m_rsAlbaran.m_FECHALB = m_rsPedido.m_FECHPED;
...
void CDlgPreAlbEntrega::RellenaAlmacen(CAlmacen *rsAlmacen, CInventario *rsInventario, CArtiAlbaran *rsArtiAlbaran, int iFila)
{
	...
	rsAlmacen->m_FECHA = m_rsPedido.m_FECHPED;
