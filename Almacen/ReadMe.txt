========================================================================
    BIBLIOTECA MFC (MICROSOFT FOUNDATION CLASS): Información general del proyecto Almacen
========================================================================


El Asistente para aplicaciones ha creado este archivo DLL de Almacen. En él se describen los fundamentos de uso
...
que componen el archivo DLL de Almacen.
...
StdAfx.h, StdAfx.cpp
    ...
    llamado Almacen.pch, así como un archivo de tipos precompilado llamado StdAfx.obj.
