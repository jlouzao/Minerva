========================================================================
    BIBLIOTECA MFC (MICROSOFT FOUNDATION CLASS): Información general del proyecto Compras
========================================================================


El Asistente para aplicaciones ha creado este archivo DLL de Compras. En él se describen los fundamentos de uso
...
que componen el archivo DLL de Compras.
...
StdAfx.h, StdAfx.cpp
    ...
    llamado Compras.pch, así como un archivo de tipos precompilado llamado StdAfx.obj.
