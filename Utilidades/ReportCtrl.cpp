...
LRESULT CReportCtrl::OnEnKillfocus( WPARAM wParam, LPARAM lParam )
{
...
/*LRESULT CReportCtrl::OnEnSetfocus( WPARAM wParam, LPARAM lParam )
{
	// Recoge el mensaje de KillFocus del CEditReport
...
BOOL CReportCtrl::SetItemTextCB(int nItem, int nSubItem, LPCTSTR lpText)
{
...
CEditReport* CReportCtrl::GetEditControl()
{
	return m_pWndEdit;
}
