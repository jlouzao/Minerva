...
void CDlgCentros::OnEnKillfocusCodigo()
{
	...
	/*if (m_strCodigo==strCodigoAux)
		return;*/
	////////////////////////////////////////////////////////////
	/*if (m_strCodigo.IsEmpty() && strCodigoAux.IsEmpty())//el anterior está vacio(acabo de entrar o limpiar)
	{
		return;
	}
	/*else if(m_strCodigo.IsEmpty() && bInicial==FALSE)//
		{
			AfxMessageBox("Es campo vacio");
		}*/
...
void CDlgCentros::OnBnClickedSig()
{
	...
	if (m_strCodigo.IsEmpty())// && !bUpdate)//si está vacio y es nuevo
	{
		OnBnClickedIni();
		return;
	}*/
