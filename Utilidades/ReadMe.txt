========================================================================
    BIBLIOTECA MFC (MICROSOFT FOUNDATION CLASS): Información general del proyecto Utilidades
========================================================================


El Asistente para aplicaciones ha creado este archivo DLL de Utilidades. En él se describen los fundamentos de uso
...
que componen el archivo DLL de Utilidades.
...
StdAfx.h, StdAfx.cpp
    ...
    llamado Utilidades.pch, así como un archivo de tipos precompilado llamado StdAfx.obj.
