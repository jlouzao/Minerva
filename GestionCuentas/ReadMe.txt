========================================================================
    BIBLIOTECA MFC (MICROSOFT FOUNDATION CLASS): Información general del proyecto GestionCuentas
========================================================================


El Asistente para aplicaciones ha creado este archivo DLL de Contabilidad. En él se describen los fundamentos de uso
...
que componen el archivo DLL de GestionCuentas.

GestionCuentas.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    llamado GestionCuentas.pch, así como un archivo de tipos precompilado llamado StdAfx.obj.
