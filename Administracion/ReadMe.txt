========================================================================
    BIBLIOTECA MFC (MICROSOFT FOUNDATION CLASS): Información general del proyecto Administracion
========================================================================


El Asistente para aplicaciones ha creado este archivo DLL de Administracion. En él se describen los fundamentos de uso
...
que componen el archivo DLL de Administracion.

Administracion.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    llamado Administracion.pch, así como un archivo de tipos precompilado llamado StdAfx.obj.
