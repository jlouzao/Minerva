========================================================================
    BIBLIOTECA MFC (MICROSOFT FOUNDATION CLASS): Información general del proyecto BaseDeDatos
========================================================================


El Asistente para aplicaciones ha creado este archivo DLL de BaseDeDatos. En él se describen los fundamentos de uso
...
que componen el archivo DLL de BaseDeDatos.
...
BaseDeDatos.h
    Archivo de encabezado principal del archivo DLL que declara la clase
    CBaseDeDatosApp.

BaseDeDatos.cpp
    Archivo DLL de código fuente principal. Contiene la clase CBaseDeDatosApp.
BaseDeDatos.rc
...
StdAfx.h, StdAfx.cpp
    ...
    llamado BaseDeDatos.pch, así como un archivo de tipos precompilado llamado StdAfx.obj.
