========================================================================
    BIBLIOTECA MFC (MICROSOFT FOUNDATION CLASS): Información general del proyecto Cobros
========================================================================


El Asistente para aplicaciones ha creado este archivo DLL de Cobros. En él se describen los fundamentos de uso
...
que componen el archivo DLL de Cobros.
...
StdAfx.h, StdAfx.cpp
    ...
    llamado Cobros.pch, así como un archivo de tipos precompilado llamado StdAfx.obj.
